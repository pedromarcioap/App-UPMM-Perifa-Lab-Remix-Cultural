  ...
  return (
    <>
      ...
      {toastAchievement && !achievement && (
        <div
          className="fixed top-5 right-5 z-[150] max-w-sm w-[92vw] sm:w-auto animate-in slide-in-from-top-4 fade-in duration-300"
        >
          <div 
      ...
      {achievement && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 overflow-y-auto animate-in fade-in duration-200">
          {/* Backdrop */}
          <div
          ...
          {/* Modal Container */}
          <div
            className="relative w-full max-w-md bg-[#2D2A26] text-white rounded-[2.5rem] border-2 border-[#FFB800] shadow-2xl p-6 sm:p-8 text-center overflow-hidden z-10 my-auto animate-in zoom-in-95 duration-200"
          >
            ...
            <div className="relative my-4 flex items-center justify-center">
              <div
                className="w-28 h-28 sm:w-32 sm:h-32 rounded-3xl bg-gradient-to-br from-[#FFB800] via-[#FFA000] to-[#FF5722] text-[#2D2A26] flex items-center justify-center text-5xl sm:text-6xl font-black shadow-2xl shadow-[#FFB800]/30 border-4 border-white/20 relative z-10 animate-pulse"
              >
                {achievement.icon || '🏆'}
              </div>
